        ...
        <div style={{ width: '100%', maxWidth: 380 }}>
          ...
          <div style={{ marginBottom: 32 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
              <SafetyCertificateFilled style={{ color: '#003882', fontSize: 18 }} />
              <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--color-primary)', letterSpacing: '1px', textTransform: 'uppercase' }}>
                Master Access
              </span>
            </div>
            <h2
          ...
          >
            ...
            <Form.Item
              label={<span style={{ color: isDarkMode ? '#cccccc' : '#334155', fontWeight: 600, fontSize: 13 }}>Master Password</span>}
              name="password"
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 28 }}>
              ...
              <a
                onClick={() => message.info('Security PIN sent to Chief Administrator hardware key.')}
